// Add a region: create its partial override and register its tag/fallback in @ken/locales.
// Add a language: create its complete base catalogue, then register its region tags there.
